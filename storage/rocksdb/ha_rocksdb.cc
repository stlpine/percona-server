...
// Counters incremented by CsdSimIterator destructors and exposed as
// SHOW STATUS variables rocksdb_csd_sim_keys_seen / _filtered.
std::atomic<uint64_t> rocksdb_csd_sim_keys_seen{0};
std::atomic<uint64_t> rocksdb_csd_sim_keys_filtered{0};
...
bool rocksdb_csd_sim_enabled = false;
...
static SHOW_VAR rocksdb_status_vars[] = {
    ...
    DEF_STATUS_VAR_PTR("csd_sim_keys_seen", &rocksdb_csd_sim_keys_seen,
                       SHOW_LONGLONG),
    DEF_STATUS_VAR_PTR("csd_sim_keys_filtered", &rocksdb_csd_sim_keys_filtered,
                       SHOW_LONGLONG),
